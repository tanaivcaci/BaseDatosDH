...
-- este no esta en el ejercicio pero esta bueno que sepamos que se puede hacer :)
 
select count(*), categorias.CategoriaNombre,
case
	WHEN UnidadesPedidas = 0 then "BAJA"
    WHEN UnidadesPedidas < UnidadesStock THEN "MEDIA"
    WHEN UnidadesPedidas * 2 < UnidadesStock THEN "URGENTE"
...
END as prioridad
 ...
 inner join categorias
 on productos.CategoriaID = categorias.CategoriaID
 group by prioridad, categorias.CategoriaNombre;
