...
-- -----------------------------------------------------
-- Table `spotify-equipo2`.`cancion_has_genero`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `spotify-equipo2`.`cancion_has_genero` (
  `idCancion` INT NOT NULL,
  `idgenero` INT NOT NULL,
  PRIMARY KEY (`idCancion`, `idgenero`),
  INDEX `fk_cancion_has_genero_genero1_idx` (`idgenero` ASC) VISIBLE,
  INDEX `fk_cancion_has_genero_cancion1_idx` (`idCancion` ASC) VISIBLE,
